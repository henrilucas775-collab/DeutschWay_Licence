    ...
    <ul class="nav-links">
      ...
      <li class="dropdown">
        ...
        <div class="dropdown-content glass" role="menu">
          <a href="{{ route('niveau-zero') }}">NIVEAU ZÉRO </a>
          <a href="{{ route('fondations') }}">FONDATIONS (A1-B1)</a>
          <a href="{{ route('immersion') }}">IMMERSION (B2-C1)</a>
        </div>
      </li>
      <li><a href="{{ route('community') }}" id="nav-communaute">COMMUNAUTÉ</a></li>
      <li><a href="{{ route('about') }}" id="nav-apropos">À PROPOS</a></li>
    </ul>

    <div class="auth-buttons">
      <a href="{{ route('login') }}" class="btn" style="border: none;">CONNEXION</a>
      <a href="{{ route('register') }}" class="btn btn-primary neon-box">S'INSCRIRE</a>
    </div>
  </nav>
</header>
