<?php
$pageTitle = "Inscription | DeutschWay";
$pageDescription = "Rejoignez la communauté DeutschWay et commencez votre apprentissage.";
...
<section class="animate-fade starfield-bg" style="min-height: 100vh; display: flex; align-items: center; justify-content: center; padding:6rem 1rem;">
    <div class="card glass neon-box w-full" style="max-width: 450px; padding: 3rem 2rem; border-radius: 2rem; position: relative;">
        <a href="index.php" class="close-modal" style="text-decoration:none; display:flex; align-items:center; justify-content:center;">×</a>
        ...
        <form id="signup-form">
            <div class="mb-4">
                ...
                <input type="text" placeholder="CyberLearner_2026" class="w-full" required>
            </div>
            <div class="mb-4">
                <label class="block text-xs font-mono text-foreground mb-2">EMAIL</label>
                <input type="email" placeholder="ton@email.com" class="w-full" required>
            </div>
            <div class="mb-4">
                <label class="block text-xs font-mono text-foreground mb-2">MOT DE PASSE</label>
                <input type="password" placeholder="••••••••" class="w-full" required>
            </div>
            <div class="mb-6">
                <label class="block text-xs font-mono text-foreground mb-2">NIVEAU ACTUEL</label>
                <select class="w-full appearance-none">
                    <option>ZÉRO (A0)</option>
        ...
        <p class="text-center mt-8 text-muted font-mono" style="font-size: 0.85rem;">
            Déjà membre ? <a href="login.php" class="text-primary font-bold transition-colors" style="text-decoration: none;">Se connecter</a>
        </p>
    </div>
</section>
