<?php
$pageTitle = "Connexion | DeutschWay";
$pageDescription = "Accédez à votre espace personnel DeutschWay.";
    ...
    <div class="card glass neon-box w-full" style="max-width: 400px; padding: 3rem 2rem; border-radius: 2rem; position: relative;">
        ...
        <form id="login-form">
            ...
            <div class="flex justify-between items-center mb-6" style="font-size: 0.75rem;">
                ...
                <a href="#" class="text-secondary font-mono transition-colors" style="text-decoration: none;" onmouseenter="this.style.color='var(--primary)'" onmouseleave="this.style.color='var(--secondary)'">Oublié ?</a>
            </div>
        ...
        <p class="text-center mt-8 text-muted font-mono" style="font-size: 0.85rem;">
            Pas encore de compte ? <a href="signup.php" class="text-primary font-bold transition-colors" style="text-decoration: none;">S'inscrire</a>
        </p>
    </div>
</section>
