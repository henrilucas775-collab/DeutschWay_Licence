<?php
$pageTitle = "Niveau Zéro | DeutschWay";
$pageDescription = "Le point de départ idéal pour les débutants complets en allemand.";
...
<section class="animate-fade starfield-bg" style="min-height:100vh; padding:6rem 1rem 4rem;">
    <div class="container">
            ...
            <aside class="destination-decor">
                <article class="destination-decor__card">
                    <img src="https://images.unsplash.com/photo-1467269204594-9661b134dd2b?auto=format&fit=crop&w=900&q=80"
                        alt="Carte illustrative de ville en Allemagne" class="destination-decor__img"
                        onerror="this.onerror=null;this.src='https://placehold.co/600x800/2d3748/ffffff?text=Image+Not+Found';">
                    <div class="destination-decor__overlay"></div>
                    <button type="button" class="destination-decor__like-btn" aria-label="Ajouter aux favoris"
                        onclick="this.classList.toggle('is-liked')">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                            <path
                                d="M12 21s-6.7-4.2-9.3-7.5C.5 10.9 2 6.7 5.8 5.6c2-.6 4.2.1 5.4 1.8 1.2-1.7 3.4-2.4 5.4-1.8 3.8 1.1 5.3 5.3 3.1 7.9C18.7 16.8 12 21 12 21z">
                            </path>
                        </svg>
                    </button>
                    <div class="destination-decor__content">
                        <p class="destination-decor__category">- Intégration Allemagne -</p>
                        <h3 class="destination-decor__title">Vie uotidienne</h3>
                    </div>
                </article>
            </aside>

            <div class="orbital-roadmap" id="orbital-roadmap" aria-label="Parcours Niveau Zéro — vue orbitale">
                <div class="orbital-roadmap__scene">
                    <div class="orbital-roadmap__bg" id="orbital-roadmap-bg" role="button" tabindex="0"
                        aria-label="Fermer le détail et reprendre la rotation"></div>
                    <div class="orbital-roadmap__perspective">
                        <div class="orbital-roadmap__center" aria-hidden="true">
                        ...
                        <div class="orbital-roadmap__orbit-ring" aria-hidden="true"></div>

                        <!-- Nœud 1 : Alphabet -->
                        <div class="orbital-node" data-id="1" data-related="2,3,5" data-energy="88">
                            <span class="orbital-node__glow"></span>
                            <button type="button" class="orbital-node__orb" aria-expanded="false"
                                aria-controls="orbital-card-1">
                            ...
                            <div class="orbital-node__card glass neon-box" id="orbital-card-1">
                                ...
                                <p class="orbital-node__card-text text-muted">Lettres, umlauts, ß et prononciation : la
                                    base pour tout le reste du parcours.</p>
                                <div class="orbital-energy">
                                    ...
                                    <div class="orbital-energy__bar"><span class="orbital-energy__fill"
                                            style="width:88%"></span></div>
                                </div>
                                <div class="orbital-related">
                                    <p
                                        class="orbital-related__title font-mono text-xs text-secondary uppercase tracking-wider mb-2">
                                        Modules liés</p>
                                    <div class="orbital-related__btns">
                                        <button type="button" class="btn orbital-jump-btn" data-orbit-jump="2">Chiffres
                                            →</button>
                                        <button type="button" class="btn orbital-jump-btn" data-orbit-jump="3">Couleurs
                                            →</button>
                                        <button type="button" class="btn orbital-jump-btn" data-orbit-jump="5">Quotidien
                                            →</button>
                                    </div>
                                </div>
                                <button type="button" class="btn btn-primary w-full mt-4 orbital-node__open-modal"
                                    data-modal="modal-alphabet">Ouvrir le module</button>
                            </div>
                        </div>
                        ...
                        <div class="orbital-node" data-id="2" data-related="1,3,5" data-energy="42">
                            ...
                            <div class="orbital-node__card glass neon-box" id="orbital-card-2">
                                ...
                                <p class="orbital-node__card-text text-muted">Compter, les ordres de grandeur et l’usage
                                    du nombre dans la vie quotidienne.</p>
                                <div class="orbital-energy">
                                    <div class="orbital-energy__row">
                                        <span class="font-mono text-xs text-muted">Progression</span>
                                ...
                                <div class="orbital-related">
                                    <p
                                        ...
                                        Modules liés</p>
                                    <div class="orbital-related__btns">
                                        <button type="button" class="btn orbital-jump-btn" data-orbit-jump="1">Alphabet
                                            →</button>
                                        <button type="button" class="btn orbital-jump-btn" data-orbit-jump="3">Couleurs
                                            →</button>
                                        <button type="button" class="btn orbital-jump-btn" data-orbit-jump="5">Quotidien
                        ...
                        <div class="orbital-node" data-id="3" data-related="2,4,5" data-energy="56">
                            ...
                            <div class="orbital-node__card glass neon-box" id="orbital-card-3">
                                ...
                                <p class="orbital-node__card-text text-muted">Vocabulaire visuel et accords simples pour
                                    décrire ce qui vous entoure.</p>
                                <div class="orbital-energy">
                                    <div class="orbital-energy__row">
                                        <span class="font-mono text-xs text-muted">Progression</span>
                                ...
                                <div class="orbital-related">
                                    ...
                                    <div class="orbital-related__btns">
                                        <button type="button" class="btn orbital-jump-btn" data-orbit-jump="2">Chiffres
                                            →</button>
                                        <button type="button" class="btn orbital-jump-btn" data-orbit-jump="4">Politesse
                                            →</button>
                                        <button type="button" class="btn orbital-jump-btn" data-orbit-jump="5">Quotidien
                                            →</button>
                                    </div>
                        ...
                        <div class="orbital-node" data-id="4" data-related="3,5" data-energy="30">
                            ...
                            <div class="orbital-node__card glass neon-box" id="orbital-card-4">
                                ...
                                <p class="orbital-node__card-text text-muted">Formules essentielles pour entrer en
                                    contact et respecter les codes du quotidien.</p>
                                <div class="orbital-energy">
                                    <div class="orbital-energy__row">
                                        <span class="font-mono text-xs text-muted">Progression</span>
                        ...
                        <div class="orbital-node" data-id="5" data-related="2,3,4" data-energy="48">
                            ...
                            <span class="orbital-node__label font-mono orbital-node__label--long"
                                title="Vie quotidienne">VIE QUOTIDIENNE</span>
                            <div class="orbital-node__card glass neon-box" id="orbital-card-5">
                                ...
                                <p class="orbital-node__card-text text-muted">Courses, transports, logement et habitudes
                                    locales : le vocabulaire et les situations que vous croisez chaque jour en
                                    Allemagne.</p>
                                <div class="orbital-energy">
                                    <div class="orbital-energy__row">
                                        <span class="font-mono text-xs text-muted">Progression</span>
            ...
            <aside class="destination-decor">
                <article class="destination-decor__card">
                    <img src="https://images.unsplash.com/photo-1527668752968-14dc70a27c95?auto=format&fit=crop&w=900&q=80"
                        alt="Culture et architecture en Allemagne" class="destination-decor__img"
                        onerror="this.onerror=null;this.src='https://placehold.co/600x800/2d3748/ffffff?text=Image+Not+Found';">
                    <div class="destination-decor__overlay"></div>
                    <button type="button" class="destination-decor__like-btn" aria-label="Ajouter aux favoris"
                        onclick="this.classList.toggle('is-liked')">
        ...
        <div class="card glass neon-box text-center mt-20" style="padding:4rem 2rem; border-radius:1.5rem;">
            <h2 class="glow-text mb-4">DÉBLOQUER L'ACCÈS COMPLET</h2>
            <p class="text-muted mb-8 font-mono mx-auto" style="max-width:36rem; line-height:1.7;">Maîtrisez les 5
                modules du Niveau Zéro et obtenez votre badge de certification pour passer au niveau supérieur.</p>
            <button onclick="navigateTo('signup')" class="btn btn-primary neon-box"
                style="padding:1.1rem 2.5rem;">SOUSCRIRE À L'OFFRE</button>
        </div>
